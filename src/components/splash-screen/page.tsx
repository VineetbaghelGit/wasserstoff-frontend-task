  ...
  return (
    <>
      <div
        ...
        {/* Title box */}
        <div className="h-[calc(100vh_-_28rem)] md:h-[calc(100vh_-_14rem)] flex items-center justify-center title-box flex-col gap-5">
          {/* Title sections */}
          <div className="first-line-anime flex gap-3 items-center">
            <h1 className="font-medium md:text-[64px] sm:text-[32px] text-[14px] leading-[10px] md:leading-[44px] text-black">
              WE
            </h1>
            <Image
              src={SplashImage1}
              ...
              alt="astrix-logo"
            />
            <h1 className="font-medium md:text-[64px] sm:text-[32px] text-[14px] leading-[15px] md:leading-[44px] text-black animate-para-first">
              ORGANIZE THE
            </h1>
          </div>
          {/* More title sections */}
          <div className="second-line-anime flex gap-3 items-center">
          ...
          <div className="third-line-anime flex items-center">
            <Image src={SplashImage3} alt="astrix-logo" />
            <div className="flex gap-3 items-center animate-para-third">
              <h1 className="font-medium md:text-[64px] sm:text-[32px] text-[14px] leading-[15px] md:leading-[44px] text-black ">
                BETWEEN
              </h1>
          ...
          <div className="fourth-line-anime flex items-center">
            <h1 className="font-medium md:text-[64px] sm:text-[32px] text-[14px] leading-[44px] text-black">
              ARTIST
            </h1>
            <Image
          ...
          <div className="fifth-line-anime flex items-center">
